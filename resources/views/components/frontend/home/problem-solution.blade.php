...
<section class="py-20 lg:py-28 bg-white dark:bg-neutral-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {{-- Problem Side --}}
            <div>
                <div class="inline-flex items-center gap-2 px-3 py-1 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-full text-sm font-medium mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <p class="text-neutral-600 dark:text-neutral-400">Poor communication and timezone differences cause delays</p>
                    </div>
                </div>
            </div>

            {{-- Solution Side --}}
            <div class="bg-gradient-to-br from-primary-50 to-white dark:from-primary-900/20 dark:to-neutral-800 rounded-3xl p-8 lg:p-10 border border-primary-100 dark:border-primary-800/50">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <p class="text-neutral-700 dark:text-neutral-300"><strong>Timezone overlap</strong> with US/UK business hours</p>
                    </div>
                </div>
                <a href="{{ route('about') }}" class="inline-flex items-center gap-2 mt-8 text-primary-600 dark:text-primary-400 font-medium hover:text-primary-700 dark:hover:text-primary-300">
