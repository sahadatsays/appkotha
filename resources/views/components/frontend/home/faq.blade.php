    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-4" x-data="{ openIndex: null }">
            ...
            @foreach($faqs as $index => $faq)
                <div class="border border-neutral-200 rounded-xl overflow-hidden" x-data="{ open: false }">
                    <button @click="open = !open" class="w-full flex items-center justify-between p-6 text-left hover:bg-neutral-50 transition-colors">
                        <span class="font-semibold text-neutral-900 pr-4">{{ $faq['question'] }}</span>
                        <svg class="w-5 h-5 text-neutral-500 shrink-0 transition-transform" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="text-center mt-12">
            ...
            <a href="{{ route('contact.index') }}" class="inline-flex items-center gap-2 text-primary-600 font-medium hover:text-primary-700">
                Contact our team
