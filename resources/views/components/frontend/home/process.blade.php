...
<section class="py-20 lg:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="w-16 h-16 bg-primary-500 rounded-2xl flex items-center justify-center mb-6 relative">
                        ...
                        <div class="absolute -right-4 top-1/2 -translate-y-1/2 hidden lg:block">
                            <svg class="w-8 h-8 text-neutral-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                            </svg>
                        </div>
                    </div>
                    <h3 class="text-xl font-bold text-neutral-900 mb-2">Discovery</h3>
            ...
            <div class="relative">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl font-bold text-neutral-900 mb-2">Planning</h3>
                    <p class="text-neutral-600 text-sm">
            ...
            <div class="relative">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl font-bold text-neutral-900 mb-2">Development</h3>
                    <p class="text-neutral-600 text-sm">
            ...
            <div class="relative">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl font-bold text-neutral-900 mb-2">Launch & Support</h3>
                    <p class="text-neutral-600 text-sm">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('contact.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-neutral-900 text-white font-semibold rounded-xl hover:bg-neutral-800 transition-colors">
                Start Your Project
