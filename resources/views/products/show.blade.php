<x-layouts.frontend :title="$product->name">
    ...
    <section class="py-20 lg:py-28 bg-gradient-to-br from-neutral-50 via-white to-primary-50 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <a href="{{ route('products.index') }}" class="inline-flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 mb-6">
                ...
                <div class="aspect-square bg-neutral-100 dark:bg-neutral-800 rounded-2xl flex items-center justify-center">
                    @if($product->image)
    ...
    @if($product->features && count($product->features) > 0)
        <section class="py-20 bg-neutral-50 dark:bg-neutral-800/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-neutral-900 dark:text-white mb-12 text-center">Features</h2>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($product->features as $feature)
                        <div class="bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-soft dark:shadow-none dark:border dark:border-neutral-700">
    ...
    @if($product->use_cases && count($product->use_cases) > 0)
        <section class="py-20 bg-white dark:bg-neutral-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-neutral-900 dark:text-white mb-12 text-center">Perfect For</h2>
