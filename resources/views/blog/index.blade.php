            ...
            <div class="grid lg:grid-cols-4 gap-12">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            @foreach($posts as $post)
                                <a href="{{ route('blog.show', $post) }}" class="group">
                                    <div class="aspect-video bg-neutral-100 dark:bg-neutral-800 rounded-xl mb-4 overflow-hidden">
                ...
                <div class="lg:col-span-1">
                    ...
                    @if($categories->count() > 0)
                        <div class="bg-neutral-50 dark:bg-neutral-800 rounded-xl p-6 mb-8">
                            <h3 class="font-bold text-neutral-900 dark:text-white mb-4">Categories</h3>
                            <ul class="space-y-3">
                                @foreach($categories as $category)
                                    <li>
                                        <a href="{{ route('blog.category', $category) }}" class="flex items-center justify-between text-neutral-600 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
