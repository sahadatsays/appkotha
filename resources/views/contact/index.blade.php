<x-layouts.frontend title="Contact Us">
    {{-- Hero Section --}}
    <section
        class="py-20 lg:py-28 bg-gradient-to-br from-neutral-50 via-white to-primary-50 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-800">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div data-aos="fade-right">
                    ...
                    <p class="text-xl text-neutral-600 dark:text-neutral-400 mb-8">
                        Have a project in mind? We'd love to hear from you. Send us a message and we'll respond within
                        24 hours.
                    </p>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4 hover:translate-x-2 transition-transform duration-300"
                            ...
                            <div
                                class="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-xl flex items-center justify-center shrink-0">
                                <svg class="w-6 h-6 text-primary-600 dark:text-primary-400 animate-float" fill="none"
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@appkotha.com"
                                    class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">hello@appkotha.com</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 hover:translate-x-2 transition-transform duration-300"
                            ...
                            <div
                                class="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-xl flex items-center justify-center shrink-0">
                                <svg class="w-6 h-6 text-primary-600 dark:text-primary-400 animate-float"
                                    style="animation-delay: 0.2s" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex items-start gap-4 hover:translate-x-2 transition-transform duration-300"
                            ...
                            <div
                                class="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 rounded-xl flex items-center justify-center shrink-0">
                                <svg class="w-6 h-6 text-primary-600 dark:text-primary-400 animate-float"
                                    style="animation-delay: 0.4s" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-elevated hover-lift"
                    ...
                    @if (session('success'))
                        <div
                            class="mb-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 rounded-xl">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" data-validate
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                <label for="name"
                                    class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Name
                                    *</label>
                            ...
                            <div>
                                <label for="email"
                                    class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Email
                                    *</label>
                        ...
                        <button type="submit" data-loading-text="Sending..."
                            class="w-full px-8 py-4 bg-primary-500 text-white font-semibold rounded-xl hover:bg-primary-600 transition-all duration-300 hover:shadow-lg btn-shine">
                            Send Message
                        </button>
                </div>
                </form>
