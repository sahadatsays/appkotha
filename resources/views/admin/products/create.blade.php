                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="features_text" id="features_text" rows="4" placeholder="Feature 1&#10;Feature 2&#10;Feature 3"
                        ...
                        <div>
                            ...
                            <textarea name="use_cases_text" id="use_cases_text" rows="4" placeholder="Use case 1&#10;Use case 2"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('use_cases_text') }}</textarea>
                        </div>
                    </div>
                </div>
