                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="features_en_text" id="features_en_text" rows="4" placeholder="Feature 1&#10;Feature 2&#10;Feature 3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('features_en_text') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="features_bn_text" id="features_bn_text" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('features_bn_text') }}</textarea>
                        </div>

                        <div>
                            <label for="use_cases_en_text" class="block text-sm font-medium text-gray-700">Use Cases (English, one per line)</label>
                            <textarea name="use_cases_en_text" id="use_cases_en_text" rows="4" placeholder="Use case 1&#10;Use case 2"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('use_cases_en_text') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="use_cases_bn_text" id="use_cases_bn_text" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('use_cases_bn_text') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="e.g., heroicon-cube"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                </div>
