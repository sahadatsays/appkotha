        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <p class="text-sm text-gray-500 mb-6">English content is required. Bangla content is optional and used when Bangla locale is selected.</p>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="auto-generated from English name"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                </div>
