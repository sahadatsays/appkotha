<x-layouts.frontend title="About Us">
    {{-- Hero Section --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-soft">
                    ...
                    <h3 class="text-xl font-bold text-neutral-900 dark:text-white mb-3">Continuous Innovation</h3>
                    <p class="text-neutral-600 dark:text-neutral-400">We stay current with the latest technologies to deliver modern, future-proof solutions.</p>
                </div>
            </div>
        </div>
    </section>
