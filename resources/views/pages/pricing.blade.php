<x-layouts.frontend title="Pricing">
    ...
    <section class="py-20 bg-white dark:bg-neutral-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-neutral-900 dark:text-white mb-12 text-center">Digital Products</h2>

            @if($products->count() > 0)
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($products as $product)
                        <div class="bg-white dark:bg-neutral-800 rounded-2xl p-8 border border-neutral-200 dark:border-neutral-700 hover:border-primary-500 dark:hover:border-primary-400 hover:shadow-elevated transition-all">
            ...
            @else
                <p class="text-center text-neutral-500 dark:text-neutral-400">Products coming soon. Contact us for more information.</p>
            @endif
        </div>
    </section>
    ...
    <section class="py-20 bg-neutral-50 dark:bg-neutral-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-neutral-900 dark:text-white mb-6 text-center">Custom Development</h2>
            <p class="text-lg text-neutral-600 dark:text-neutral-400 text-center mb-12 max-w-2xl mx-auto">
                Every project is unique. We provide custom quotes based on your specific requirements and scope.
            </p>

            <div class="grid md:grid-cols-3 gap-8 mb-12">
                <div class="bg-white dark:bg-neutral-800 rounded-2xl p-8 border border-neutral-200 dark:border-neutral-700">
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-2xl p-8 border-2 border-primary-500 relative">
